...
namespace VFHCatalogMVC.Infrastructure.Migrations
{
    ...
    [Migration("20230404115100_changesInTableFilters3")]
    partial class changesInTableFilters3
    {
            ...
            modelBuilder.Entity("VFHCatalogMVC.Domain.Model.Filters", b =>
                {
                    ...
                    b.Property<bool>("GrowingSeazonVisible")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("VFHCatalogMVC.Domain.Model.Filters", b =>
                {
                    ...
                    b.HasOne("VFHCatalogMVC.Domain.Model.Destination", null)
                        .WithMany("Filters")
                    ...
                    b.HasOne("VFHCatalogMVC.Domain.Model.Position", null)
                        .WithMany("Filters")
