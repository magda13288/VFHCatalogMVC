...
namespace VFHCatalogMVC.Infrastructure.Migrations
{
    ...
    [Migration("20230420102406_NewTablesProducerAndSoilPh")]
    partial class NewTablesProducerAndSoilPh
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VFHCatalogMVC.Domain.Model.AdditionalFeatures", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VFHCatalogMVC.Domain.Model.Filters", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("FruitSizeVisible")
                        .HasColumnType("bit");

                    b.Property<int?>("FruitTypeId")
                        .HasColumnType("int");

                    b.Property<bool>("FruitTypeVisible")
                        .HasColumnType("bit");

                    b.Property<bool>("GrowingSeazon")
                        .HasColumnType("bit");

                    b.Property<int?>("GrowthTypeId")
                        .HasColumnType("int");

                    b.Property<bool>("GrowthTypeVisible")
                        .HasColumnType("bit");

                    b.Property<int?>("HeightId")
                        .HasColumnType("int");

                    b.Property<bool>("HeightVisible")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("PollinationId")
                        .HasColumnType("int");

                    b.Property<bool>("PollinationVisible")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("VFHCatalogMVC.Domain.Model.Height", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VFHCatalogMVC.Domain.Model.PlantPosition", b =>
                {
                    b.Property<int>("PlantDetailId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PlantDetailId", "PositionId");

                    b.HasIndex("PositionId");

                    b.ToTable("PlantPositions");
                });

            modelBuilder.Entity("VFHCatalogMVC.Domain.Model.PlantProducers", b =>
                {
                    b.Property<int>("ProducerId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ProducerId", "PlantDetailId");

                    b.HasIndex("PlantDetailId");

                    b.ToTable("PlantProducers");
                });
            ...
            modelBuilder.Entity("VFHCatalogMVC.Domain.Model.PlantSoilPh", b =>
                {
                    b.Property<int>("SoilPhId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("SoilPhId", "PlantDetailId");

                    b.HasIndex("PlantDetailId");

                    b.ToTable("PlantSoilPhs");
                });
            ...
            modelBuilder.Entity("VFHCatalogMVC.Domain.Model.Pollination", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Pollinations");
                });

            modelBuilder.Entity("VFHCatalogMVC.Domain.Model.Position", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VFHCatalogMVC.Domain.Model.Producer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VFHCatalogMVC.Domain.Model.SoilPh", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VFHCatalogMVC.Domain.Model.Filters", b =>
                {
                    ...
                    b.HasOne("VFHCatalogMVC.Domain.Model.Height", "Height")
                        .WithMany("Filters")
                    ...
                    b.HasOne("VFHCatalogMVC.Domain.Model.Pollination", "Pollination")
                        .WithMany("Filters")
                        .HasForeignKey("PollinationId");
                });
            ...
            modelBuilder.Entity("VFHCatalogMVC.Domain.Model.PlantDetail", b =>
                {
                    b.HasOne("VFHCatalogMVC.Domain.Model.AdditionalFeatures", "AdditionalFeatures")
                    ...
                    b.HasOne("VFHCatalogMVC.Domain.Model.Destination", "Destination")
                        .WithMany("PlantDetails")
                        .HasForeignKey("DestinationId");
                    ...
                    b.HasOne("VFHCatalogMVC.Domain.Model.Position", "Position")
                        .WithMany("PlantDetails")
                        .HasForeignKey("PositionId");

                    b.HasOne("VFHCatalogMVC.Domain.Model.Producer", "Producer")
                        .WithMany("PlantDetail")
                        .HasForeignKey("ProducerId");

                    b.HasOne("VFHCatalogMVC.Domain.Model.SoilPh", null)
                        .WithMany("PlantDetails")
                        .HasForeignKey("SoilPhId");
                });
            ...
            modelBuilder.Entity("VFHCatalogMVC.Domain.Model.PlantSoilPh", b =>
                {
                    b.HasOne("VFHCatalogMVC.Domain.Model.PlantDetail", "PlantDetail")
                        .WithMany("PlantSoilPhs")
                        .HasForeignKey("PlantDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VFHCatalogMVC.Domain.Model.SoilPh", "SoilPh")
                        .WithMany("PlantSoilPhs")
                        .HasForeignKey("SoilPhId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
