...
namespace VFHCatalogMVC.Tests
{
    public class PlantServiceTests
    {
        ...
        //    // Ustawienie kontekstu, aby zwraca³ zamockowany DbSet<>
        //    mockContext.Setup(m=>m.Plants).Returns(mockSet.Object);

        //    // Tworzymy instancjê PlantRepository z zamockowanym kontekstem.
        ...
        //    // Assert
        //    // Sprawdzenie, czy metoda Add zosta³a wywo³ana raz z odpowiednim plantem

        //    mockSet.Verify(m=>m.Add(It.Is<Plant>(p=>p == newPlant)), Times.Once());

        //    // Sprawdzenie, czy metoda SaveChangesAsync zosta³a wywo³ana raz
